...
<div class="container-fluid login-container">
    <div class="row h-100">
        ...
        <div class="col-md-6 welcome-section text-center">
            ...
            <p class="mt-3">Create your account to start using the billing system</p>
        ...
        <div class="col-md-6 login-section">
			...
			String error = (String) session.getAttribute("registerError");
				...
				<%
				session.removeAttribute("registerError"); // clear after showing
				    }
				%>
                <form action="<%= request.getContextPath() %>/RegisterServlet" method="post">
                    ...
                    <p class="text-left text-muted">Already have an account? 
